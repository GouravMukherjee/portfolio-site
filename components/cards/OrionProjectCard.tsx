      ...
      <div className="relative z-10 space-y-6">
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-2">
              <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                ...
                <span className="text-base font-semibold text-accent-white sm:text-xl">Multi-Agent AI Companion</span>
              </div>
        ...
        >
          <a
            ...
            className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-primary border-2 border-accent-white px-6 py-3 font-bold text-accent-white transition-all hover:bg-accent-white hover:text-primary sm:w-auto"
          >
          ...
          <a
            ...
            className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-transparent border-2 border-accent-white px-6 py-3 font-bold text-accent-white transition-all hover:bg-accent-white hover:text-primary sm:w-auto"
          >
            <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
